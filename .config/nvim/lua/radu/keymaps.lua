...
nnoremap("]d", function() vim.diagnostic.jump({ count = 1, float = true }) end, { desc = "Go to next diagnostic message (all severities)" })
nnoremap("[d", function() vim.diagnostic.jump({ count = -1, float = true }) end, { desc = "Go to next diagnostic message (all severities)" })
nnoremap("]e", function() vim.diagnostic.jump({ count = 1, float = true, severity = vim.diagnostic.severity.E }) end, { desc = "Go to next diagnostic error" })
nnoremap("[e", function() vim.diagnostic.jump({ count = -1, float = true, severity = vim.diagnostic.severity.E }) end, { desc = "Go to previous diagnostic error" })
nnoremap("]w", function() vim.diagnostic.jump({ count = 1, float = true, severity = vim.diagnostic.severity.W }) end, { desc = "Go to next diagnostic warning" })
nnoremap("[w", function() vim.diagnostic.jump({ count = -1, float = true, severity = vim.diagnostic.severity.W }) end, { desc = "Go to previous diagnostic warning" })
